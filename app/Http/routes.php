...
//external Supervisor Confirmation link
    Route::get('/externalSupervisorConfirmation/{stuentId}/{projectId}','projectController@externalSupextervisorConfirmation');
...
//    Route::get('addFreeSlot', 'FreeSlotController@store');
    ...
    Route::post('viewSubmissions','submissionsController@viewSubmissionsDetails');
    Route::get('viewSubmissions','submissionsController@selectSubmissions');
