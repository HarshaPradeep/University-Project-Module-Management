...
class supevaluationController extends Controller {
    ...
    public function createproreport() {
        ...
        return view('supevaluation.propreportevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function srscreate() {
        ...
        return view('supevaluation.srsevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function protocreate() {
        ...
        return view('supevaluation.protoevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function midprsentcreate() {
        ...
        return view('supevaluation.midprsentevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function finalprsentcreate() {
        ...
        return view('supevaluation.finalprsentevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function finalstatuscreate() {
        ...
        return view('supevaluation.finalstatusevaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function vivacreate() {
        ...
        return view('supevaluation.vivavaluation', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
    ...
    public function othercreate() {
        ...
        return view('supevaluation.otherassess', compact('students', 'supervisaornames', 'studentid', 'groupids', 'los'));
    }
        ...
        if (Request::get('cmntmem0') != null && Input::get('statustab1') != "Absent") {
            ...
            EvaluationMarks::where('stuid', Request::get('cmntmem0'))
                    ->update([
                        ...
                        'completedassesment' => 'proposalreport'
            ]);
        }
        ...
        if (Request::get('cmntmem0') != null && Input::get('statustab1') != "Absent") {
            ...
            EvaluationMarks::where('stuid', Request::get('cmntmem0'))
                    ->update([
                        ...
                        'completedassesment' => 'finalprsent'
            ]);
        }
        ...
        if (Request::get('cmntmem0') != null && Input::get('statustab1') != "Absent") {
            ...
            EvaluationMarks::where('stuid', Request::get('cmntmem0'))
                    ->update([
                        ...
                        'completedassesment' => 'finalreport'
            ]);
        }
