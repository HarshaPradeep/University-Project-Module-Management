...
<div class="ibox-content" style="font-size: 14">
        <table class="table table-bordered">
            <tbody style="font-size: 15">                
                <tr>
                    <td style="width: 1000px"><strong>SRS</strong> (9%)</td>
                </tr> 
                <tr>
...
Good (7-6)
Average (5-4)
Below Average (3-0)">LO 1 * (10%)</td>
                    <td style="width: 1000px" title="Excellent (30-24)
Good (23-18)
Average (17-12)
Below Average (11-0)">LO 2 * (30%)</td>
...
Below Average (3-0)">LO 4 * (10%)</td>
        ...
        <div align="right" style="padding-right: 42px">
            ...
            &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total (9%)" style="width: 100px; height: 35px" disabled> / 
...
{//add trnry operation, get 0 if null
    ...
    $('#totalcon'+whtmem).val(((first2 + second2) / 100) * 9);
}
