                ...
                <div class="tab-content">
                        ...
                        <div class="ibox-content" style="font-size: 14">
                            <table class="table table-bordered">
                                <tbody style="font-size: 15">                
                                    <tr>
                                        <td style="width: 1000px"><strong>SRS</strong> ({{$los->srsdoc}}%)</td>
                                    </tr> 
                                    <tr>
                                        ...
                                        <td style="width: 1000px" title="Excellent (10-8)
                                            Good (7-6)
                                            Average (5-4)
                                            Below Average (3-0)">LO 1 * ({{$los->srslo1}}%)</td>
                                        <td style="width: 1000px" title="Excellent (30-24)
                                            Good (23-18)
                                            Average (17-12)
                                            Below Average (11-0)">LO 2 * ({{$los->srslo2}}%)</td>
                                        <td style="width: 1000px" title="Excellent (50-40)
                                            Good (39-30)
                                            Average (29-20)
                                            Below Average (19-0)">LO 3 * ({{$los->srslo3}}%)</td>
                                        <td style="width: 1000px" title="Excellent (10-8)
                                            Good (7-6)
                                            Average (5-4)
                                            Below Average (3-0)">LO 4 * ({{$los->srslo4}}%)</td>
                                        <td style="width: 1000px">Status Document ({{$los->srsstatus}}%)</td>
                                    </tr>
                                    <tr>
                            ...
                            &nbsp;
                            <div align="right" style="padding-right: 42px">
                                <input type="text"  placeholder="Total ({{$los->srsdoc}}%)" style="width: 100px; height: 35px" disabled> / 
                                <input type="text" name="marksforsrstab1" id="totalconmem1" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
                            <br>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="member2"> 
                        <div class="ibox-content" style="font-size: 14">
                            ...
                            <div align="right" style="padding-right: 42px">
                                <input type="text"  placeholder="Total ({{$los->srsdoc}}%)" style="width: 100px; height: 35px" disabled> / 
                                <input type="text" name="marksforsrstab2" id="totalconmem2" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
                            <br>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="member3"> 
                        <div class="ibox-content" style="font-size: 14">
                            ...
                            <div align="right" style="padding-right: 42px">
                                <input type="text"  placeholder="Total ({{$los->srsdoc}}%)" style="width: 100px; height: 35px" disabled> / 
                                <input type="text" name="marksforsrstab3" id="totalconmem3" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
                            <br>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="member4"> 
                        <div class="ibox-content" style="font-size: 14">
                            ...
                            <div align="right" style="padding-right: 42px">
                                <input type="text"  placeholder="Total ({{$los->srsdoc}}%)" style="width: 100px; height: 35px" disabled> / 
                                <input type="text" name="marksforsrstab4" id="totalconmem4" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
                            <br>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="member5"> 
                        <div class="ibox-content" style="font-size: 14">
                            ...
                            <div align="right" style="padding-right: 42px">
                                <input type="text"  placeholder="Total ({{$los->srsdoc}}%)" style="width: 100px; height: 35px" disabled> / 
                                <input type="text" name="marksforsrstab5" id="totalconmem5" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
                            <br>
 ...
 function selectStudentDetails()
 {
    ...
    var searchID = e.options[e.selectedIndex].value;
        ...
        dataType: 'json'
            ...
            lo1val = data['los']['srslo1'];
            lo2val = data['los']['srslo2'];
            lo3val = data['los']['srslo3'];
            lo4val = data['los']['srslo4'];
            lo5val = data['los']['srsstatus'];
...
{//add trnry operation, get 0 if null
    ...
    $('#totalcon'+whtmem).val(((first2 + second2) / 100) * srsdoc);
}
