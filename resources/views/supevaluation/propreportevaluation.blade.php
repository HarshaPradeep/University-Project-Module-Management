...
Below Average (14-0)">LO 1 * (35%)</td>
                    ...
                    <td style="width: 1000px">LO 5 * (15%)</td>
                </tr>
                <tr>
        ...
        <p style="alignment-adjust: central; font-size: medium"><a href="{{ asset('public_assets/img/marking_guids/CDAP Assessment Instruments-Proposal Report.pdf')}}" 
                                         target="_blank"><strong>Assessment Instruments</strong></a></p>
