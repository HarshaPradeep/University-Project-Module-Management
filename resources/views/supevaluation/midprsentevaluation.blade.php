...
<div class="ibox-content" style="font-size: 14">
        <table class="table table-bordered">
            <tbody style="font-size: 15">                
                <tr>
                    <td style="width: 1700px"><strong>Mid Review Presentation</strong> (10%)</td>
                </tr> 
                <tr>
...
Good (23-18)
Average (17-12)
Below Average (11-0)">LO 3 * (30%)</td>
                    <td style="width: 1000px" title="Excellent (20-16)
Good (15-12)
Average (11-8)
Below Average (7-0)">LO 4 * (20%)</td>
                    <td style="width: 1000px" title="Excellent (10-8)
Good (7-6)
Average (5-4)
Below Average (3-0)">LO 5 * (10%)</td>
                </tr>
                <tr>
...
{//add trnry operation, get 0 if null
    ...
    $('#totalcon'+whtmem).val(((first2 + second2 + third1) / 100) * 10);
}
