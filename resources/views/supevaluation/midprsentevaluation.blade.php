...
<div class="ibox-content" style="font-size: 14">
        <table class="table table-bordered">
            <tbody style="font-size: 15">                
                <tr>
                    <td style="width: 1700px"><strong>Mid Review Presentation</strong> ({{$los->midpresent}}%)</td>
                </tr> 
                <tr>
...
Good (11-9)
Average (8-6)
Below Average (5-0)">LO 1 * ({{$los->midprelo1}}%)</td>
                    <td style="width: 1000px" title="Excellent (25-20)
Good (19-15)
Average (14-10)
Below Average (9-0)">LO 2 * ({{$los->midprelo2}}%)</td>
                    <td style="width: 1000px" title="Excellent (30-24)
Good (23-18)
Average (17-12)
Below Average (11-0)">LO 3 * ({{$los->midprelo3}}%)</td>
                    <td style="width: 1000px" title="Excellent (20-16)
Good (15-12)
Average (11-8)
Below Average (7-0)">LO 4 * ({{$los->midprelo4}}%)</td>
                    <td style="width: 1000px" title="Excellent (10-8)
Good (7-6)
Average (5-4)
Below Average (3-0)">LO 5 * ({{$los->midprelo5}}%)</td>
                </tr>
                <tr>
        ...
        <p style="alignment-adjust: central; font-size: medium"><a href="{{ asset('public_assets/img/marking_guids/CDAP Assessment Instruments-Mid Review Presentation.pdf')}}" 
        ...
        &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total ({{$los->midpresent}}%)" style="width: 100px; height: 35px" disabled> / 
            <input type="text" name="marksformidpresenttab1" id="totalconmem1" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
<br>
...
Below Average (3-0)">LO 5 * ({{$los->midprelo5}}%)</td>
        ...
        &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total ({{$los->midpresent}}%)" style="width: 100px; height: 35px" disabled> / 
            <input type="text" name="marksformidpresenttab2" id="totalconmem2" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
<br>
...
Below Average (3-0)">LO 5 * ({{$los->midprelo5}}%)</td>
        ...
        &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total ({{$los->midpresent}}%)" style="width: 100px; height: 35px" disabled> / 
            <input type="text" name="marksformidpresenttab3" id="totalconmem3" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
<br>
...
Below Average (3-0)">LO 5 * ({{$los->midprelo5}}%)</td>
        ...
        &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total ({{$los->midpresent}}%)" style="width: 100px; height: 35px" disabled> / 
            <input type="text" name="marksformidpresenttab4" id="totalconmem4" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
<br>
...
Below Average (3-0)">LO 5 * ({{$los->midprelo5}}%)</td>
        ...
        &nbsp;
            <div align="right" style="padding-right: 42px">
        <input type="text"  placeholder="Total ({{$los->midpresent}}%)" style="width: 100px; height: 35px" disabled> / 
            <input type="text" name="marksformidpresenttab5" id="totalconmem5" style="width: 50px; ; height: 35px" readonly placeholder="0"> <b>Marks</b></div>
<br>
 ...
 function selectStudentDetails()
 {
    ...
    var searchID = e.options[e.selectedIndex].value;
        ...
        dataType: 'json'
            ...
            lo1val = data['los']['midprelo1'];
            lo2val = data['los']['midprelo2'];
            lo3val = data['los']['midprelo3'];
            lo4val = data['los']['midprelo4'];
            lo5val = data['los']['midprelo5'];
...
{//add trnry operation, get 0 if null
    ...
    $('#totalcon'+whtmem).val(((first2 + second2 + third1) / 100) * midpresent);
}
