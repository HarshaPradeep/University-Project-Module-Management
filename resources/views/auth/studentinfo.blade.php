...
<form class="form-horizontal" method="post">
                                ...
                                <label class="col-lg-2 control-label">Student No</label>
                                    ...
                                    <div class="col-sm-6"><select class="form-control m-b" name="studentId" >
                                                                         @foreach($rp as $std)
                                                                         ...
                                                                         @endforeach
                                                                          ...
                                                                          @if ($errors->has('studentId')) <p class="help-block"><font color="red">{{ $errors->first('studentId') }}</font></p> @endif
                                   ...
                                   <button class="btn btn-w-m btn-primary" type="submit">View Student profile</button>
                                  </div>
