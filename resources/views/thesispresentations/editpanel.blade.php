                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            {!! Form::open(array('route'=>['thesispanels.update', Crypt::encrypt($presentationPanel->id) ],'onsubmit' => 'return (checktime() & checkMember());', 'method'=>'PUT', 'id'=>'editpanelform')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <input id="date" class="form-control" value="{{$presentationPanel->date}}"  name="date" type="date" min="{{date("Y-m-d")}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-sm-offset-7">
                                    <a class="btn btn-white" href="{{URL::route('thesispanels.index')}}">Cancel</a>
    ...
    <script type="text/javascript">
        ...
        function getSupervisor() {
            ...
            $.ajax({
                ...
                type: "GET",
                url: 'http://localhost:8000/getsupervisor', 
                dataType: 'JSON',
        ...
        function selectMember1() {
            ...
            $.ajax({
                ...
                type: "GET",
                url: 'http://localhost:8000/member1', 
                dataType: 'JSON',
                data: {"memberId": memId}
