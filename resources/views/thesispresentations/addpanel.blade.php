                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            {!! Form::open(array('route'=>'thesispanels.store','method'=>'POST', 'onsubmit' => 'return !!(checktime() & checkMember());', 'id'=>'panelform')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <select id="panelmember1" name="panelmember1" class="form-control"  onchange="checkMember('panelmember1','panelmember2','txtSupervisor')" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <select id="panelmember2" name="panelmember2" class="form-control" onchange="checkMember('panelmember1','panelmember2','txtSupervisor')">
                                        <option value="">Select A Member</option>
                                        @foreach($panelMembers as $member)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" placeholder="Start Time" id="startTime" name="startTime" type="time" min="{{date("08:00")}}" max="{{date("18:00")}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input class="form-control" placeholder="End Time" id="endTime" name="endTime" type="time" min="{{date("08:00")}}" max="{{date("19:00")}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 col-sm-offset-8">
                                    <br />
                                    <a class="btn btn-danger" href="{{URL::route('thesispanels.index')}}">Cancel</a>
                                    <br />
    ...
    <script type="text/javascript">
        ...
        function getSupervisor() {
            ...
            $.ajax({
                ...
                type: "GET",
                url: 'http://localhost:8000/getsupervisor', // This is what I have updated
                dataType: 'JSON',
        ...
        function selectMember1() {
            ...
            $.ajax({
                ...
                type: "GET",
                url: '/member1', // This is what I have updated
                dataType: 'JSON',
                data: {"memberId": memId}
