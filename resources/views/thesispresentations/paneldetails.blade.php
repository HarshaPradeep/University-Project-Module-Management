        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group col-lg-4">
                    {!! link_to_route('thesispanels.edit', 'Edit', Crypt::encrypt($panel->id), ['class' => 'col-lg-2 btn btn-warning btn-block']) !!}
                    <a class="col-lg-2 btn btn-success btn-block" href="{{URL::route('thesispanels.index')}}">Cancel</a>
                    {!! Form::open(['method' => 'DELETE', 'onsubmit' => 'return confirm("Are you sure?");', 'route' => ['thesispanels.destroy', Crypt::encrypt($panel->id)]]) !!}
