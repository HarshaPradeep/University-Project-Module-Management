...
@section('css_links')
        ...
        <title>External Supervisor Projects</title>
@endsection
@section('title')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>External Supervisors Projects</h2>
            <ol class="breadcrumb">
      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>External Supervisor Projects</h5>
                      ...
                      <table style="font-size: 13px" class="table table-striped table-bordered table-hover dataTables-example dataTable dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                          ...
                          @foreach($key3 as $prj)
                              <tr class="gradeA even" role="row">
                                  ...
                                  <td class="center"><a href="{{ asset('studentDetails/' . $prj->email)}}">{{$prj->email}}</a></td>
                                  <td class="center"><a href='externalSupervisorIDetail/{{$prj->email}}'>{{ $prj->email}}</a></td>
                              </tr>
                          @endforeach
