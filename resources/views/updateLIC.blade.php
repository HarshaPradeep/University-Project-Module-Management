...
@section('title')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Update Lecturer In charge</h2>
            <ol class="breadcrumb">
    ...
    <div class="ibox float-e-margins animated fadeInRight">
        ...
        <div class="row">
            ...
            <form class="form-horizontal" method ="post" action="updateExternalSupervisorSubmit">
                <div class="form-group"><label class="col-sm-2 control-label">Search(Email)</label>
                ...
                {{--['lectureInCharge_fullName', 'lectureInCharge_contactNumber','lectureInCharge_email','lectureInCharge_speciality--}}
                <div class="form-group"><label class="col-sm-2 control-label">Status</label>

                    <div class="col-sm-10">
                        <input id="lectureInCharge_fullName" name="lectureInCharge_fullName" placeholder="Full Name"
                                                  type="text" class="form-control required"/></div>
                </div>

                <div class="form-group"><label class="col-sm-2 control-label">Status</label>

                    <div class="col-sm-10"><input id="lectureInCharge_contactNumber" name="lectureInCharge_contactNumber" placeholder="Contact Number"
                                                  type="text" class="form-control required"/></div>
                </div>
                ...
                <div class="form-group" id="emailDiv"><label class="col-sm-2 control-label">Email</label>
                    ...
                    <div class="col-sm-10">
                        <input id="lectureInCharge_speciality" name="lectureInCharge_speciality"
                               placeholder="Speciality" class="form-control required"
