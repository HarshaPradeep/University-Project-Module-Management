     ...
     <div class="col-lg-12">
       <div class="ibox float-e-margins">
         <div class="ibox-title">
            <h5>External Supervisor Proposal Evaluations</h5>
         </div>
         ...
         <div class="ibox-content">
          ...
          <div>
            <form id=12 method="post">
              ...
              <a href="viewInternalProjects" class="btn btn-primary btn-xs m-l-sm">View All</a>
            </form>
          ...
          <table class="table table-striped table-bordered table-hover dataTables-example dataTable dtr-inline" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
              ...
              <tbody>
                 @foreach($projects as $project)
                  ...
                  <td class="center">
                    <a href="{{ asset('ViewPrposal/'.$project->id) }}" class="edit_btn btn btn-primary btn-xs m-l-sm">Form </a>
                  </td>
                 </tr>
