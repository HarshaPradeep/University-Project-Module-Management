...
@section('content')
    ...
    <div class="row" style="padding-left: 14px">
        <div class="col-lg-8">
            <form id="form1" name="form1" method="post" action="/dupdate/{{ $defect[0]->id }}" >


                <div class="form-group">
                    <input name="entertask" class="form-control" value="{{ $defect[0]->defect }}" type="text" required>
                </div>

                <div class="form-group">
                    <textarea name="desc" class="form-control" rows="3">{{ $defect[0]->description }}</textarea>
                </div>

                <div class="form-group">
                    <input name="plantof" class="form-control" value="{{ $defect[0]->plantofinish }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="radio" >
                        ...
                        @elseif($defect[0]->state == "Not Start")
                ...
                <div class="form-group" id="start_date">
                    <input name="start" class="form-control" value="{{ $defect[0]->sdate }}">
                </div>

                <div class="form-group" id="end_date">
                    <input name="end" class="form-control" value="{{ $defect[0]->edate }}" placeholder="Enter the end date">
                </div>

                <div class="form-group" id="spent_hours">
                    <input name="spenthours" class="form-control" value="{{ $defect[0]->hours }}" placeholder="Enter the spent hours">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding-left:100px;">
                        <button onclick="updateDefect('{{ $defect[0]->id }}')" name="addNotice" id="adda"class="btn btn-w-m btn-primary">Update</button>
